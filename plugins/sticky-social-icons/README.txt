...
= 1.1.1 =
* Fix: Animation settings not working.
* Fix: Width not updating in front end.
* Fix: Wrong validation message was showing if the plugin was saved with the empty width and height value.

= 1.1.0 =
* Change icon padding settings to Icon width and height in admin.
